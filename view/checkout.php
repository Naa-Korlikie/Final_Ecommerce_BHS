					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="news.html">Programs</a>
	...
	<div class="checkout-section mt-150 mb-150">
        ...
        //Displaying the products in the cart on the payment page to show the customer what they are paying for
                            ...
                            { 
                                ...
                                echo
                                    ...
                                    <tbody class='order-details-body'>
                                        ...
                                        <h4 class='title'>" . $item['product_title'] . "</h4>
                                            <td><div class='amount'>GHC " . $item['product_price'] ."</td>
                                        </tr>
                                    </tbody>
                                    <tbody class='checkout-details'>
                                        <tr>
                                            <td>Subtotal</td>
                                            <td><?php echo count($cart). 'items' ?></td>
                                        </tr>
                                        <tr>
                                            <td>Items</td>
                                ...
                                <a href='payment.php' class='boxed-btn'>Place Order</a>";
