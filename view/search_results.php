			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						<h3><span class="orange-text">Searrch</span> ressults</h3>
			...
			<?php
				foreach ($productlist as $aproduct) {
					...
					<div class='col-lg-4 col-md-6 text-center'>
						...
						<a href='../action/add_to_cart.php' class='cart-btn'><i class='fas fa-shopping-cart'></i> Add to Cart</a>
						</div>";
						}else{
