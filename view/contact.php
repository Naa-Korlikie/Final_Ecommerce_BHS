			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="form-title">
						...
						<p>Send us a message about your concerns. An agent will contact you to help you out. </p>
					</div>
				 	<div id="form_status"></div>
					<div class="contact-form">
						<form type="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
							<p>
								<input type="text" placeholder="Name" name="cname" id="name">
				...
				<div class="col-lg-4">
					<!-- <div class="contact-form-wrap">
						...
						<div class="contact-form-box">
							...
							<p>Phone: +233541318411 <br> Email: support@bhs.com</p>
						</div>
					</div>
				</div>
			</div>
