<?php
include("../actions/program_function.php");
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Join us Live for </p>
							<h1>Click the link in the the program description to join us live</h1>
							<div class="hero-btns">
								</div>
						</div>
					</div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th>Program Name</th>
                        <th>Program Date</th>
                        <th>Program  Description/ Link</th>
                ...
                <?php
                    if ($programlist) 
                    {
                        ...
                        foreach ($programlist as $aprogram) 
                        {
                            $programID = $aprogram['program_id'];
                            $program_title = $aprogram['program_title'];
                            $program_desc = $aprogram['program_description'];
                            $program_date = $aprogram['program_date'];
